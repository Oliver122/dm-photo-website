...
/// How often the background refresher re-checks open tickets.
const REFRESH_INTERVAL: Duration = Duration::from_secs(3 * 60 * 60); // 3 hours

/// Outcome of a refresh cycle, used for admin feedback.
...
/// Spawn a background task that refreshes open tickets every 3 hours.
