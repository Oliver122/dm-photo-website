...
## Worker slice branches (REQ-005)

Parent controls `feat/dm-analog-ingest`. Composer workers may open `feat/dm-analog-ingest-slice-*` for research/docs only first; parent reviews and merges. Do not implement product code on slices until the parent plan in `.ai/reviews/2026-08-06-dm-analog-photoprism-plan.md` says go.
